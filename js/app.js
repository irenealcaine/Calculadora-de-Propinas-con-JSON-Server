...
function mostrarPlatillos(platillos) {
  ...
  platillos.forEach(platillo => {
    ...
    inputCantidad.classList.add('form-ccontrol')
...
function actualizarResumen() {
  ...
  heading.textContent = 'Platillos consmidos'
  ...
  pedido.forEach(articulo => {
    ...
    subtotalValor.innerHTML = calcularSubtotal(precio, cantidad)
